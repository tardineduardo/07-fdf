...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/23 18:23:03 by eduribei          #+#    #+#             */
/*   Updated: 2024/12/23 20:11:25 by eduribei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_center_map_in_place(t_point *point, t_map *map, mlx_image_t *img)
{
	...
	(void)img;
	delta_x = point->x_scr - point->x_scr_old;
	delta_y = point->y_scr - point->y_scr_old;
...
void	ft_center(t_map *map)
{
	...
	map->x_scr_var = (map->img->width / 2.0)
		- ((map->max_x_scr + map->min_x_scr) / 2.0);
	map->y_scr_var = (map->img->height / 2.0)
		- ((map->max_y_scr + map->min_y_scr) / 2.0);
